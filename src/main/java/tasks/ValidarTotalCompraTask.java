...
import static userinterfaces.ElementosWebSwagLabs.MENSAJE_IMPUESTO;

@AllArgsConstructor
public class ValidarTotalCompraTask implements Task {
    ...
    public static ValidarTotalCompraTask validarTotalCompra(Map<String, String> mapDatos) {
        return instrumented(ValidarTotalCompraTask.class, mapDatos);
    }
